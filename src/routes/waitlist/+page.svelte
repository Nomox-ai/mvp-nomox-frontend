	...
	<main class="border-border flex flex-1 items-center border-b">
		...
		>
			...
			>
				...
				<h1
					class="text-foreground text-3xl font-semibold tracking-tight leading-tight"
				>
					Get started
				</h1>
				<p
					class="text-muted-foreground mt-4 max-w-xs text-sm leading-relaxed"
				>
					We're launching soon. Leave your email and we'll reach out
					when we do.
				</p>

				<div class="mt-10 grid gap-5">
					{#each [{ num: "01", text: "Free during early access." }, { num: "02", text: "Works with PostgreSQL, MongoDB, Trino and more." }, { num: "03", text: "MCP-ready for Claude, Cursor and any compatible AI client." }] as item}
			...
			<div class="flex flex-col justify-center px-8 py-14">
				<p class="text-muted-foreground mb-6 font-mono text-xs">
					Request access
				</p>
				<WaitlistForm />
