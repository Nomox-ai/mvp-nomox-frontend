...
<Dialog.Root {open} onOpenChange={handleOpenChange}>
	<Dialog.Portal>
		...
		/>
		<Dialog.Content
			class="fixed left-1/2 top-1/2 z-50 -translate-x-1/2 -translate-y-1/2 w-[520px] max-w-[95vw] bg-background border border-border rounded-xl shadow-xl outline-none"
		>
			<!-- Header -->
